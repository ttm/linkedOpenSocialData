...
Computer scripts are in public git repositories and PyPI Python packages.
Although most data is already in open licenses (Twitter, Email, Participabr,
Cidade Democrática, and AA data), IRC and Facebook data was collected
